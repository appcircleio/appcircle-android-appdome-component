...
secured_app_output=../Appdome_$(basename $app_file)
...
secured_app_output="$AC_REPOSITORY_DIR/$(basename $secured_app_output)"
certificate_output="$AC_REPOSITORY_DIR/$(basename $certificate_output)"
